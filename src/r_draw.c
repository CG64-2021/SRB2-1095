...
void R_LoadSkinTable(void)
{
	...
	for (i = 0; i < MAXSKINS; i++)
		translationtables[i] = Z_Malloc(256*(MAXSKINCOLORS-1), PU_STATIC, NULL); //Z_MallocAlign (256*(MAXSKINCOLORS-1), PU_STATIC, NULL, 16);
}
...
void R_InitTranslationTables(void)
{
	...
	transtables = Z_Malloc(NUMTRANSTABLES*0x10000, PU_STATIC, NULL); //Z_MallocAlign(NUMTRANSTABLES*0x10000, PU_STATIC, NULL, 16);
	...
	defaulttranslationtables = Z_Malloc(256*MAXSKINCOLORS, PU_STATIC, NULL); //Z_MallocAlign(256*MAXSKINCOLORS, PU_STATIC, NULL, 16);
	...
	bosstranslationtables = Z_Malloc(256, PU_STATIC, NULL); //Z_MallocAlign(256, PU_STATIC, NULL, 16);
