...
CV_PossibleValue_t gametype_cons_t[] =
{
	...
	{GT_RACE, "Competition"}, //Race in 1.09.4 is actually Competition mode
	{GTF_TIMEONLYRACE, "Race"}, //Time-only Race in 1.09.4 is actually Race mode from 2.0 and later 
	{GT_TAG, "Tag"},
	{GT_CTF, "CTF"},
#ifdef CHAOSISNOTDEADYET
	{GT_CHAOS, "Chaos"},
...
static void M_ChangeLevel(int choice)
{
	...
	M_ClearMenus(true);
	COM_BufAddText(va("map %s -gametype \"%s\" -skill %i\n", mapname, cv_newgametype.string, cv_skill.value));
}

static menuitem_t ChangeLevelMenu[] =
{
	{IT_STRING|IT_CVAR,				 NULL, "Skill",					&cv_skill,			10},
...
static menuitem_t ControlsMenu[] =
{
	...
	{IT_STRING  | IT_CVAR, NULL, "Crosshair (1P)", &cv_crosshair , 90}, // Changed all to normal string Tails 11-30-2000

	{IT_STRING  | IT_CVAR, NULL, "Camera (2P)"  , &cv_chasecam2 , 100}, // Changed all to normal string Tails 11-30-2000
	//{IT_STRING  | IT_CVAR, NULL, "Autoaim (2P)" , &cv_autoaim2  , 120}, // Changed all to normal string Tails 11-30-2000
	{IT_STRING  | IT_CVAR, NULL, "Crosshair (2P)", &cv_crosshair2, 110}, // Changed all to normal string Tails 11-30-2000
...
{
	{IT_STRING | IT_CALL, NULL, "Switch Map...",           M_MapChange,        0},
...
#endif
	{IT_STRING | IT_CVAR, NULL, "Intermission Timer", 	  &cv_inttime, 		   70},
	{IT_STRING | IT_CVAR, NULL, "Advance to next level",  &cv_advancemap,      80},
	{IT_STRING | IT_CVAR, NULL, "Server controls skin",   &cv_forceskin,       90},
...
//	int i;
	...
	if (!menuactive)
	{
		switch (ch)
		{
			...
			//KEY_F12 is reserved for viewpoint!
